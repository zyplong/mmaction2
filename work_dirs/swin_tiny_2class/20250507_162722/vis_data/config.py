ann_file_test = 'projects/seasonal_pseudo_change/datasets/splits/val.txt'
ann_file_train = 'projects/seasonal_pseudo_change/datasets/splits/train.txt'
ann_file_val = 'projects/seasonal_pseudo_change/datasets/splits/val.txt'
...
test_dataloader = dict(
    batch_size=4,
    dataset=dict(
        ann_file='projects/seasonal_pseudo_change/datasets/splits/val.txt',
        data_prefix=dict(
...
train_dataloader = dict(
    batch_size=4,
    dataset=dict(
        ann_file='projects/seasonal_pseudo_change/datasets/splits/train.txt',
        data_prefix=dict(
            img='projects/seasonal_pseudo_change/datasets/rawframes'),
        pipeline=[
            dict(type='RawFrameDecode'),
